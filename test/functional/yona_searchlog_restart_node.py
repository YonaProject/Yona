...
from test_framework.yona import generatesynchronized
from test_framework.yonaconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class YonaRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    YonaRPCSearchlogsTestModified().main()