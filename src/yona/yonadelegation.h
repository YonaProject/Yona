#ifndef YONADELEGATION_H
#define YONADELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IYonaStaker class Delegation filter
 */
...
/**
 * @brief The YonaDelegation class Communicate with the yona delegation contract
 */
class YonaDelegation {
    
public:
    /**
     * @brief YonaDelegation Constructor
     */
    YonaDelegation();

    /**
     * @brief ~YonaDelegation Destructor
     */
    virtual ~YonaDelegation();
...
private:
    YonaDelegation(const YonaDelegation&);
    YonaDelegation& operator=(const YonaDelegation&);
    YonaDelegationPriv* priv;
};
#endif
