...
static const uint64_t DEFAULT_MIN_GAS_PRICE_DGP = 4;
...
public:
    ...
    YonaDGP(YonaState* _state, CChainState& _chainstate, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state), chainstate(_chainstate) { initDataSchedule(); }
