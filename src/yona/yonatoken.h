...
public:
    ...
    void setYonaTokenExec(YonaTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strYonaAddress, std::string& strHash160);
    static bool ToYonaAddress(const std::string& strHash160, std::string& strYonaAddress);
...
private:
    ...
    YonaToken(YonaToken const&);
    YonaToken& operator=(YonaToken const&);
