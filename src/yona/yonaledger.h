...
/**
 * @brief The YonaLedger class Communicate with the yona ledger
 */
class YonaLedger {
    
public:
    /**
     * @brief YonaLedger Constructor
     */
    YonaLedger();

    /**
     * @brief ~YonaLedger Destructor
     */
    virtual ~YonaLedger();
...
private:
    YonaLedger(const YonaLedger&);
    YonaLedger& operator=(const YonaLedger&);
    YonaLedgerPriv* d;
};
#endif
