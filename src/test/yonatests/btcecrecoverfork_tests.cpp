...
//    initState();
    ...
    std::vector<YonaTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createYonaTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createYonaTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createYonaTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createYonaTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
