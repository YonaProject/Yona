...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex->hashStateRoot.GetHex()); // yona
    result.pushKV("hashUTXORoot", blockindex->hashUTXORoot.GetHex()); // yona

    if(blockindex->IsProofOfStake()){
        result.pushKV("prevoutStakeHash", blockindex->prevoutStake.hash.GetHex()); // yona
        result.pushKV("prevoutStakeVoutN", (int64_t)blockindex->prevoutStake.n); // yona
    }
...
RPCHelpMan getdelegationinfoforaddress()
{
    return RPCHelpMan{"getdelegationinfoforaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The yona address string"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    YonaDelegation yonaDelegation;
    Delegation delegation;
    PKHash pkhash = std::get<PKHash>(dest);
    uint160 address = uint160(pkhash);
    if(!yonaDelegation.GetDelegation(address, delegation, chainman.ActiveChainstate())) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegation");
    }
    bool verified = yonaDelegation.VerifyDelegation(address, delegation);
...
RPCHelpMan getdelegationsforstaker()
{
    return RPCHelpMan{"getdelegationsforstaker",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The yona address string for staker"},
                },
               RPCResult{
            RPCResult::Type::ARR, "", "",
                {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if(!yonaDelegation.FilterDelegationEvents(events, filter, chainman)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegations for staker");
    }
    std::map<uint160, Delegation> delegations = yonaDelegation.DelegationsFromEvents(events);
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /* optional */ true, "yona address (only if a well-defined address exists)"},
                    {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of yona addresses",
                        {{RPCResult::Type::STR, "address", "yona address"}}},
                }},
...
static RPCHelpMan yrc20info()
{
    return RPCHelpMan{"yrc20info",
                "\nReturns info about yrc20 token\n",
                {
                ...
                RPCExamples{
                    HelpExampleCli("yrc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("yrc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan yrc20name()
{
    return RPCHelpMan{"yrc20name",
...
static RPCHelpMan yrc20symbol()
{
    return RPCHelpMan{"yrc20symbol",
                ...
                RPCExamples{
                    HelpExampleCli("yrc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("yrc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan yrc20totalsupply()
{
    return RPCHelpMan{"yrc20totalsupply",
                ...
                RPCExamples{
                    HelpExampleCli("yrc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("yrc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan yrc20decimals()
{
    return RPCHelpMan{"yrc20decimals",
                ...
                RPCExamples{
                    HelpExampleCli("yrc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("yrc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan yrc20balanceof()
{
    return RPCHelpMan{"yrc20balanceof",
                "\nReturns the token balance for address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The yona address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("yrc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("yrc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Get parameters
...
static RPCHelpMan yrc20allowance()
{
    return RPCHelpMan{"yrc20allowance",
                "\nReturns remaining tokens allowed to spend for an address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressfrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The yona address of the account owning tokens"},
                    {"addressto", RPCArg::Type::STR, RPCArg::Optional::NO,  "The yona address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("yrc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
            + HelpExampleRpc("yrc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Set contract address
...
static RPCHelpMan yrc20listtransactions()
{
    return RPCHelpMan{"yrc20listtransactions",
                "\nReturns transactions history for a specific address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The yona address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver yona address"},
                            {RPCResult::Type::STR, "sender", "The sender yona address"},
                ...
                RPCExamples{
                    HelpExampleCli("yrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleCli("yrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
            + HelpExampleRpc("yrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("yrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    // Get parameters
...
{ //  category              actor (function)
  //  --------------------- ------------------------
    ...
    { "blockchain",         &yrc20info,                          },
    { "blockchain",         &yrc20name,                          },
    { "blockchain",         &yrc20symbol,                        },
    { "blockchain",         &yrc20totalsupply,                   },
    { "blockchain",         &yrc20decimals,                      },
    { "blockchain",         &yrc20balanceof,                     },
    { "blockchain",         &yrc20allowance,                     },
    { "blockchain",         &yrc20listtransactions,              },
