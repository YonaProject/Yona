...
////////////////////////////////////////////////////////////// // yona
    void setYonaSchedule(EVMSchedule _yonaSchedule) const { yonaSchedule = _yonaSchedule; }

    EVMSchedule& getYonaSchedule() const { return yonaSchedule; }
...
private:
    ...
    mutable EVMSchedule yonaSchedule; // yona
