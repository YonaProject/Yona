...
const char * const BITCOIN_CONF_FILENAME = "yona.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Yona
    // macOS: ~/Library/Application Support/Yona
    // Unix-like: ~/.yona
#ifdef WIN32
    // Windows
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Yona Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Yona Core Developers";
    }
