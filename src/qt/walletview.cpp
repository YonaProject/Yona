    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new YonaPushButton(tr("&Export"), this);
    ...
    YRCTokenPage = new YRCToken(platformStyle);
    ...
    // Pass through messages from YRCTokenPage
    connect(YRCTokenPage, &YRCToken::message, this, &WalletView::message);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    YRCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    YRCTokenPage->setModel(_walletModel);
