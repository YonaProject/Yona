...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Это ваши yona-адреса для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        <source>These are your Yona addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses.
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Это ваши yona-адреса для получения платежей. Используйте кнопку «Создать новый адрес для получения» на вкладке Получить, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Предупреждение: если вы зашифруете кошелёк и потеряете парольную фразу, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ YONAS&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        <source>Remember that encrypting your wallet cannot fully protect your yonas from being stolen by malware infecting your computer.</source>
        <translation type="unfinished">Помните, что шифрование кошелька не может полностью защитить ваши yonas от кражи вредоносными программами, заражающими ваш компьютер.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введите yona-адрес (напр. %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить средства на yona-адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения вашими yona-адресами, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверяйте сообщения, чтобы убедиться, что они подписаны конкретными yona-адресами</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Запросить платёж (генерирует QR-коды и URI протокола yona:)</translation>
    </message>
    <message>
    ...
    <message>
        <source>Load Partially Signed Yona Transaction</source>
        <translation type="unfinished">Загрузить частично подписанную yona-транзакцию (PSBT)</translation>
    </message>
    <message>
        <source>Load Partially Signed Yona Transaction from clipboard</source>
        <translation type="unfinished">Загрузить частично подписанную yona-транзакцию из буфера обмена</translation>
    </message>
    <message>
    ...
    <message>
        <source>Open a yona: URI</source>
        <translation type="unfinished">Открыть URI протокола yona:</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n активное подключение к сети Yona.</numerusform>
            <numerusform>%n активных подключений к сети Yona.</numerusform>
            <numerusform>%n активных подключений к сети Yona.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введенный адрес "%1" не является действительным yona-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%1 скачает и сохранит копию цепочки блоков yona.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неверным. Информация станет верной после завершения синхронизации с сетью yona, прогресс которой вы можете видеть ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Open yona URI</source>
        <translation type="unfinished">Открыть URI yona</translation>
    </message>
    </context>
<context>
    ...
    <message>
        <source>Full path to a Yona Core compatible script (e.g. C:\Downloads\hwi.exe or /Users/you/Downloads/hwi.py). Beware: malware can steal your coins!</source>
        <translation type="unfinished">Полный путь к сценарию, совместимому с Yona Core (например, C:\Downloads\hwi.exe или /Users/you/Downloads/hwi.py). Осторожно: вредоносные программы могут украсть ваши монеты!</translation>
    </message>
    <message>
        ...
        <translation>Автоматически открыть порт yona-клиента на маршрутизаторе. Работает, если ваш маршрутизатор поддерживает UPnP, и данная функция на нём включена.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Automatically open the Yona client port on the router. This only works when your router supports NAT-PMP and it is enabled. The external port could be random.</source>
        <translation type="unfinished">Автоматически открыть порт yona-клиента на роутере. Работает? если ваш роутер поддерживает NAT-PMP, и данная функция на нём включена. Внешний порт может быть случайным.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключиться к сети yona через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Connect to the Yona network through a separate SOCKS5 proxy for Tor onion services.</source>
        <translation type="unfinished">Подключаться к сети yona через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Показанная информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью yona после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Не удаётся запустить обработчик click-to-pay для протокола yona:</translation>
    </message>
    <message>
    ...
    <message>
        <source>'yona://' is not a valid URI. Use 'yona:' instead.</source>
        <translation type="unfinished">«yona://» — это неверный URI. Используйте вместо него «yona:».</translation>
    </message>
    <message>
...
Если вы получили эту ошибку, вам следует попросить у продавца URI, совместимый с BIP21.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Не удалось обработать URI! Это может быть вызвано тем, что yona-адрес неверен или параметры URI неправильно сформированы.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Внимание: это сообщение не будет отправлено вместе с платежом через сеть yona.</translation>
    </message>
    <message>
...
Примечание: так как комиссия рассчитывается пропорционально размеру в байтах, комиссия «100 сатоши за ВКБ» для транзакции размером 500 виртуальных байт (половина 1 ВКБ) приведет к сбору в размере всего 50 сатоши.</translation>
    ...
    <message>
        <source>When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for yona transactions than the network can process.</source>
    ...
    <message>
        <source>Creates a Partially Signed Yona Transaction (PSBT) for use with e.g. an offline %1 wallet, or a PSBT-compatible hardware wallet.</source>
        <translation type="unfinished">Создает частично подписанную yona-транзакцию (PSBT), чтобы использовать её, например, с офлайновым кошельком %1, или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Please, review your transaction proposal. This will produce a Partially Signed Yona Transaction (PSBT) which you can save or copy and then sign with e.g. an offline %1 wallet, or a PSBT-compatible hardware wallet.</source>
        <translation type="unfinished">Пожалуйста, ещё раз просмотрите черновик вашей транзакции. Будет создана частично подписанная yona-транзакция (PSBT), которую можно сохранить или скопировать, после чего подписать, например, офлайновым кошельком %1 или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Предупреждение: неверный yona-адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Yona-адрес, на который нужно отправить платёж</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Комиссия будет вычтена из отправляемой суммы. Получателю придёт меньше yonaов, чем вы ввели в поле «Сумма». Если выбрано несколько получателей, комиссия распределяется поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Сообщение, которое было прикреплено к URI и которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть yona.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Вы можете подписывать сообщения/соглашения своими адресами, чтобы доказать, что вы можете получать yonas на них. Будьте осторожны и не подписывайте непонятные или случайные сообщения, так как мошенники могут таким образом пытаться присвоить вашу личность. Подписывайте только такие сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The Yona address to sign the message with</source>
        <translation type="unfinished">Yona-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation type="unfinished">Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение yona-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Проверить сообщение, чтобы убедиться, что оно действительно подписано указанным yona-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
...
<context>
    ...
    <message>
        <source>%s corrupt. Try using the wallet tool yona-wallet to salvage or restoring a backup.</source>
        <translation type="unfinished">%s испорчен. Попробуйте восстановить с помощью инструмента yona-wallet или восстановите из резервной копии.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Error: Dumpfile version is not supported. This version of yona-wallet only supports version 1 dumpfiles. Got dumpfile with version %s</source>
        <translation type="unfinished">Ошибка: версия дамп-файла не поддерживается. Эта версия yona-wallet поддерживает только дамп-файлы версии 1. Обнаружено дамп-файл версии %s</translation>
    </message>
    <message>
