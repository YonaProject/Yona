...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YONA");
    case mBTC: return QString("mYONA");
    case uBTC: return QString::fromUtf8("μYONA (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Yonas");
    case mBTC: return QString("Milli-Yonas (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Yonas (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
