    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(YonaHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(YonaHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(YonaHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(YonaHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(YonaHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(YonaHwiTool::derivationPathBech32());
