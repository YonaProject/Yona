#ifndef YONAVERSIONCHECKER_H
#define YONAVERSIONCHECKER_H

#include <QObject>

#define YONA_RELEASES "https://github.com/yonaproject/yona/releases"
...
class YonaVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit YonaVersionChecker(QObject *parent = 0);
    ~YonaVersionChecker();
