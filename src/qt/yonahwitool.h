#ifndef YONAHWITOOL_H
#define YONAHWITOOL_H
...
/**
 * @brief The YonaHwiTool class Communicate with the Yona Hardware Wallet Interface Tool
 */
class YonaHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief YonaHwiTool Constructor
     * @param parent Parent object
     */
    explicit YonaHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~YonaHwiTool Destructor
     */
    ~YonaHwiTool();
